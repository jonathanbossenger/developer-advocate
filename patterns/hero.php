  ...
  <div class="wp-block-group hero-inner">
    ...
    <div class="wp-block-group hero-content">
      ...
      <div class="hero-links">
        ...
        <a href="https://www.twitch.tv/jonathanbossenger">
        ...
        <a href="https://x.com/jon_bossenger">
        ...
        <a href="https://fosstodon.org/@jonathanbossenger">
          <svg viewBox="0 0 24 24" fill="currentColor"><path d="M23.268 5.313c-.35-2.578-2.617-4.61-5.304-5.004C17.51.242 15.792 0 11.813 0h-.03c-3.98 0-4.835.242-5.288.309C3.882.692 1.496 2.518.917 5.127.64 6.412.61 7.837.661 9.143c.074 1.874.088 3.745.26 5.611.118 1.24.325 2.47.62 3.68.55 2.237 2.777 4.098 4.96 4.857 2.336.792 4.849.923 7.256.38.265-.061.527-.132.786-.213.585-.184 1.27-.39 1.774-.753a.057.057 0 0 0 .023-.043v-1.809a.052.052 0 0 0-.02-.041.053.053 0 0 0-.046-.01 20.282 20.282 0 0 1-4.709.545c-2.73 0-3.463-1.284-3.674-1.818a5.593 5.593 0 0 1-.319-1.433.053.053 0 0 1 .066-.054 19.648 19.648 0 0 0 4.636.536c.562 0 1.124-.02 1.669-.058 1.868-.135 3.868-.404 5.332-1.248.057-.033.117-.064.18-.098 1.4-.759 2.702-2.199 2.808-5.197.012-.084.043-.878.043-1.39 0-.423.165-3.004-.057-4.585z"/><path d="M19.903 7.738v6.18h-2.448V7.91c0-1.265-.527-1.908-1.582-1.908-1.166 0-1.75.762-1.75 2.27v3.283h-2.434V8.271c0-1.507-.584-2.27-1.75-2.27-1.055 0-1.582.643-1.582 1.91v6.006H5.91V7.738c0-1.264.322-2.27.97-3.013a3.347 3.347 0 0 1 2.456-1.023c.884 0 1.555.34 2.004 1.02l.432.726.432-.726c.449-.68 1.12-1.02 2.004-1.02.953 0 1.756.34 2.458 1.023.646.744.966 1.749.966 3.013h.271z"/></svg>
          Mastodon
        </a>
      </div>
      <!-- /wp:html -->
    ...
    <div class="wp-block-group hero-photo">
      <!-- wp:image {"className":"hero-photo-frame","sizeSlug":"full"} -->
      <figure class="wp-block-image size-full hero-photo-frame"><img src="https://jonathanbossenger.com/wp-content/uploads/2026/02/profile-2023-square-scaled.jpg" alt="Jonathan Bossenger"/></figure>
      <!-- /wp:image -->
